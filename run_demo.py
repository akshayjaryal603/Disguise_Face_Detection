...
if __name__ == '__main__':
    ...
    parser.add_argument('--imgDir', default='./img/', type=str, help='path to test images')
    parser.add_argument('--outDir', default='./img/', type=str, help='path for saving prediction results')
